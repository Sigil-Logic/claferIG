/*
All clafers: 24 | Abstract: 4 | Concrete: 20 | Reference: 6
Constraints: 26
Goals: 3
Global scope: 1..*
...
open util/integer
pred show {}
run show for 1 but 7 c0_ComfortFeature, 10 c0_Feature, 5 c0_FuelFeature, 7 c0_comfort, 10 c0_cost, 5 c0_fuel
...
{ one @r_c0_CC.this
  ((this.@r_c0_fuel).@c0_fuel_ref) = 1
  ((this.@r_c0_comfort).@c0_comfort_ref) = 3
  ((this.@r_c0_cost).@c0_cost_ref) = 4 }

sig c0_ACC extends c0_FuelFeature
{}
{ one @r_c0_ACC.this
  ((this.@r_c0_fuel).@c0_fuel_ref) = 2
  ((this.@r_c0_comfort).@c0_comfort_ref) = 6
...
{ one @r_c0_Automatic.this
  ((this.@r_c0_fuel).@c0_fuel_ref) = 2
  ((this.@r_c0_comfort).@c0_comfort_ref) = 2
  ((this.@r_c0_cost).@c0_cost_ref) = 3 }

sig c0_Manual extends c0_FuelFeature
{}
{ one @r_c0_Manual.this
  ((this.@r_c0_fuel).@c0_fuel_ref) = 0
  ((this.@r_c0_comfort).@c0_comfort_ref) = 1
  ((this.@r_c0_cost).@c0_cost_ref) = 2 }
...
{ one @r_c0_FCA.this
  ((this.@r_c0_fuel).@c0_fuel_ref) = 2
  ((this.@r_c0_comfort).@c0_comfort_ref) = 4
  ((this.@r_c0_cost).@c0_cost_ref) = 5 }
...
{ c0_total_comfort_ref : one Int }
{ one @r_c0_total_comfort.this }

sig c0_total_fuel
{ c0_total_fuel_ref : one Int }
